...
model_name = "imgnet_iou_pred_all"
# test_mode = "ytvis_iou_pred_test"
test_mode = "frame_iou_pred_test"
SCORE_THRESHOLD = 0.8
arg_text = f"--num-gpus 1 --config-file configs/imagenet_video/{model_name}.yaml  MODEL.WEIGHTS videocutler_m2f_rn50.pth OUTPUT_DIR OUTPUT-DIR/{model_name} MODEL_NAME {model_name}"
...
inf_results = res[cfg.DATASETS.TEST[0]]["results"]
