...
SOCRE_IOU_THRESHOLD = 0.95
num_gpus = 3

def main():
    model_name = "eval"
    test_mode = "ytvis_default"
    score_iou_threshold = SOCRE_IOU_THRESHOLD
    round_idx = 0
    # model_weights = "OUTPUT-DIR/imgnet_iou_pred_all/model_final.pth"
    # model_weights = "OUTPUT-DIR/ytvis_s025iouf_allnf_cn075_adding_refresh_g2_b4/model_best.pth"
    model_weights = "pretrain/videocutler_m2f_rn50.pth"
    # model_weights = "pretrain/cutler_m2f_rn50.pth"
